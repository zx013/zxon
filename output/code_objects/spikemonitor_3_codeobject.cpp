...
double* const _array_spikemonitor_3_v = _dynamic_array_spikemonitor_3_v.empty()? 0 : &_dynamic_array_spikemonitor_3_v[0];
const int _numv = _dynamic_array_spikemonitor_3_v.size();
...
const int _num_source_idx = 10;
 ...
 double* __restrict  _ptr_array_spikemonitor_3_v = _array_spikemonitor_3_v;
    ...
    if (_num_events > 0)
    {
        ...
        if (_num_events > 0) {
            ...
            for(int _j=_start_idx; _j<_end_idx; _j++)
            {
                ...
                _dynamic_array_spikemonitor_3_v.push_back(_to_record_v);
